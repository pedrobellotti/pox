...
def flood(event, ini, fim):
  ...
  log.info("Barrier Request enviado em: "+str(tempoEnv)+" ID:"+str(id))
...
def _handle_ConnectionUp (event):
  ...
  msg6.match.nw_proto = 6  # tcp = 6 e udp = 17
  msg6.match.tp_src = 22
  msg6.priority = 20
  msg6.actions.append(of.ofp_action_output(port = of.OFPP_LOCAL))
  event.connection.send(msg6)

  msg7 = of.ofp_flow_mod()
  msg7.match.in_port = of.OFPP_LOCAL
  msg7.match.dl_type = 0x0800
  msg7.match.nw_proto = 6  # tcp = 6 e udp = 17
  msg7.match.tp_src = 22
  msg7.priority = 20
  msg7.actions.append(of.ofp_action_output(port = 3))
  event.connection.send(msg7)  
